package com.charles.sqlupdatedemo;
...
import com.charles.sqlupdatedemo.sqlhelp.MySQLiteOpenHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String DB_NAME = "test_carson";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copy_to_sdcard = (Button) findViewById(R.id.copy_to_sdcard);
        ...
        copy_to_sdcard.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.instablish:
                ...
                MySQLiteOpenHelper dbHelper = new MySQLiteOpenHelper(this, DB_NAME);
            ...
            case R.id.upgrade:
                // 创建SQLiteOpenHelper子类对象
                MySQLiteOpenHelper dbHelper_upgrade = new MySQLiteOpenHelper(this, "test_carson");
            ...
            case R.id.insert:
                ...
                // 创建SQLiteOpenHelper子类对象
                MySQLiteOpenHelper dbHelper1 = new MySQLiteOpenHelper(this, "test_carson");
                // 调用getWritableDatabase()方法创建或打开一个可以读的数据库
                ...
                break;
            case R.id.chat1:
                MySQLiteOpenHelper helper = new MySQLiteOpenHelper(this, "test_carson");
                // 调用getWritableDatabase()方法创建或打开一个可以读的数据库
                SQLiteDatabase sqliteDatabaseHelper = helper.getWritableDatabase();
            ...
            case R.id.query:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper4 = new MySQLiteOpenHelper(MainActivity.this, "test_carson");
                // 调用getWritableDatabase()方法创建或打开一个可以读的数据库
            ...
            case R.id.modify:
                ...
                MySQLiteOpenHelper dbHelper2 = new MySQLiteOpenHelper(MainActivity.this, "test_carson");
            ...
            case R.id.delete:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper3 = new MySQLiteOpenHelper(MainActivity.this, "test_carson");
    ...
    private void copyToSdCard() {
        ...
        File dbFile = new File(Environment.getDataDirectory().getAbsolutePath() + "/data/" + getPackageName() + "/databases/" + DB_NAME);
